"""
Latent Rescaling Network (LRN) - Navier-Stokes Experiment (One-Stage).
...
def train_lrr(args, device, train_loader, test_loader):
    ...
    trainer = Trainer(
        ...
        stage1_lr=1e-3,
        weight_decay=0.0,
        checkpoint_dir='checkpoints_ns_onestage',
        scheduler_type='step',
...
def main():
    ...
    # Save Results
    out_dir = Path('results/plots/navier_stokes/one_stage')
