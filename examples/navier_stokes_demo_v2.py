"""
Navier-Stokes Demo for LRN-FNO - VERSION 2 (2-Stage Training)
...
def visualize_ns_predictions(model_fno, model_lrn, dataset, device='cpu', filename='ns_comparison_v2.png'):
